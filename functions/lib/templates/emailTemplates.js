...
exports.generate2FATextTemplate = exports.generate2FAEmailTemplate = void 0;
const generate2FAEmailTemplate = (code, expiresAt) => {
...
exports.generate2FAEmailTemplate = generate2FAEmailTemplate;
// Alternative plain text template for email clients that don't support HTML
const generate2FATextTemplate = (code, expiresAt) => {
    const expiryTime = new Date(expiresAt);
    const now = new Date();
    const minutesLeft = Math.floor((expiryTime.getTime() - now.getTime()) / (1000 * 60));
    return `
...
exports.generate2FATextTemplate = generate2FATextTemplate;
